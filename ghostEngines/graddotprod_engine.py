...
class GradDotProdEngine:
    ...
    def __init__(
        ...
        include_layer_names: Optional[Sequence[str]] = None,
    ):
        """
        ...
        self.include_layer_names = list(include_layer_names) if include_layer_names else None
    ...
    def attach(self, optimizer: torch.optim.Optimizer):
        ...
        autograd_grad_sample_dotprod.add_hooks(
            ...
            include_layer_names=self.include_layer_names,
        )
