...
This script provides a clean interface for training GPT models with
In-Run Data Shapley value computation as described in "Data Shapley in One Training Run".
"""
...
from config_file import parse_arguments, InRunShapleyConfig
...
from training_loop import InRunShapleyTrainer
...
def main():
    ...
    config = InRunShapleyConfig(args)
